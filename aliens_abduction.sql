...
INSERT INTO aliens_abduction VALUES ('Barry', 'Logan', '2013-11-22', '3 days', '55', 'Short with long hair.', 'Eat every thing that faces him.', 'yes', 'Do not feed him.', 'barry@logan.com');

SELECT * FROM aliens_abduction;
SELECT * FROM aliens_abduction WHERE HOW_MANY = 'just one';
